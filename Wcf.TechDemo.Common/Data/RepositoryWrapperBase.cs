namespace TechDemo.Data {
    ...
    public abstract class RepositoryWrapperBase<TRepository, TEntity> : IRepository<TEntity> where TRepository : IRepository<TEntity> {
        readonly TRepository _rootRepository;

        /// <summary>
        /// Default Constructor.
        /// Creates a new instance of the <see cref="RepositoryWrapperBase{TRepository,TEntity}"/> class.
        /// </summary>
        /// <param name="rootRepository">The <see cref="IRepository{TEntity}"/> instance to wrap.</param>
        protected RepositoryWrapperBase(TRepository rootRepository) {
            _rootRepository = rootRepository;
        }

        ///<summary>
        /// Gets the <see cref="IRepository{TEntity}"/> instance that this RepositoryWrapperBase wraps.
        ///</summary>
        ...
        public virtual IEnumerator<TEntity> GetEnumerator() {
            return _rootRepository.GetEnumerator();
        }
        ...
        public virtual Expression Expression {
            get { return _rootRepository.Expression; }
        }
        ...
        public virtual Type ElementType {
            get { return _rootRepository.ElementType; }
        }
        ...
        public virtual IQueryProvider Provider {
            get { return _rootRepository.Provider; }
        }
        ...
        public virtual T UnitOfWork<T>() where T : IUnitOfWork {
            return _rootRepository.UnitOfWork<T>();
        }
        ...
        public virtual void Refresh(TEntity entity) {
            _rootRepository.Refresh(entity);
        }
        ...
        public virtual IEnumerable<TEntity> Query(ISpecification<TEntity> specification) {
            return _rootRepository.Query(specification);
        }
        ...
        public IQueryable<TEntity> For<TService>() {
            return _rootRepository.For<TService>();
        }
    }
}